 ...
 *     fetch_credentials?: "same-origin"|"include"|"omit", // The default fetch credentials mode for all Live Components ('same-origin', 'include', 'omit') // Default: "same-origin"
 * }
 ...
 *         manage_seed?: bool, // Automatically manage faker seed to ensure consistent data between test runs. // Default: true
