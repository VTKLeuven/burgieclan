...
def normalize_document(d, course_code, course_name):
    ...
    # 4. H01M3A: Elektronische basisschakelingen
        ...
        if "bodeplotmaker.mw" in fn.lower():
            ...
            cat_id = 3
            year = "2018 - 2019"
            author = "Tibo Geenen & Benoit Cattoir"
            ...
            if fn.lower().startswith("ariane_"):
                ...
                tags.append("English")
        elif "notes and exercises by nick hosewol" in path.lower():
            author = "Nick Hosewol"
            if "oefenzitting" in fn.lower():
                ...
                if is_sol:
                    tags.append("Oplossing")
                if "oefenzitting 2 ebs -  nick hosewol.pdf" == fn.lower():
            ...
            if "circuit_naar_signaalverwerkingsblok" in fn.lower():
                ...
                tags.append("Formularium")
            elif "nic vermeeren" in fn.lower():
                author = "Nic Vermeeren"
                title = "Samenvatting EBS"
            elif "milan schoofs" in fn.lower():
                year = "2024 - 2025"
                author = "Milan Schoofs"
                title = "Samenvatting EBS"
                tags.append("Handgeschreven")
            elif "martijn deckers" in fn.lower():
                year = "2017 - 2018"
                author = "Martijn Deckers"
            ...
            if "2019-1.jpg" == fn.lower():
            ...
            elif "examen ebs _ tibo geenen" in fn.lower():
                year = "2018 - 2019"
                author = "Tibo Geenen"
                title = "Examen EBS"
                tags.append("Handgeschreven")
                ...
                tags.extend(["Handgeschreven", "Deel 2"])
            elif "thomas goossens" in fn.lower():
                year = "2007 - 2008"
    ...
    # 5. H01M1A: Elektromagnetische golven
        ...
        if "studentencursus_2019-2020" in fn.lower():
            ...
            tags.append("English")
        elif "examen emg 12-06-2023 - nick hosewol" in fn.lower():
            cat_id = 2
            year = "2022 - 2023"
            author = "Nick Hosewol"
            ...
            elif "steven claessens" in fn.lower():
                author = "Steven Claessens"
            ...
            elif "thomas vyncke" in fn.lower():
                author = "Thomas Vyncke"
                title = "Oefenzitting 2 (Oplossing)"
                tags.extend(["Oplossing", "Handgeschreven", "Deel 2"])
            elif "sarah muys" in fn.lower():
                year = "2018 - 2019"
                author = "Sarah Muys"
                title = "Oefenzittingen"
                tags.extend(["Bundel / Alle", "Handgeschreven"])
            elif "matthias demaerschalk" in full_context_lower or "emg_stubs_md" in fn.lower():
                author = "Matthias Demaerschalk"
            ...
            if "leidraden 2006-2007 (oplossing)" in fn.lower():
                ...
                tags.append("Formularium")
            elif "jasper visterin" in full_context_lower:
                year = "2022 - 2023"
                author = "Jasper Visterin"
    ...
    # 6. H01L1A: Digitale elektronica en processoren
        ...
        if "inhoudstafel dep" in fn.lower():
            ...
            cat_id = 3
            if "kevin lepinoy" in fn.lower():
                year = "2019 - 2020"
                author = "Kevin Lepinoy"
                ...
                title = "Samenvatting"
                tags.append("Handgeschreven")
            elif "lara-roosens" in fn.lower() or "lararoosens" in fn.lower():
                author = "Lara Roosens"
                title = "Samenvatting - Schema's"
            elif "annelies verreth" in fn.lower():
                year = "2018 - 2019"
                author = "Annelies Verreth"
    ...
    # 7. H01M5A: Halfgeleidercomponenten
        ...
        if "tussentijdse toetsen" in path.lower() or "ttt" in fn.lower():
            cat_id = 5
            if "ellen anthonissen" in fn.lower():
                author = "Ellen Anthonissen"
            ...
            if "oefenzittingen hgc" in path.lower():
                m_oz = re.search(r'oefenzitting\s*(\d+)\s*hgc\s*-\s*(.*?)\s*-\s*(?:oplossingen?\s*-\s*)?nick hosewol', fn.lower())
                if m_oz:
                    oz_num = m_oz.group(1)
                ...
                cat_id = 6
                m_part = re.search(r'part\s*(\d+)\s*-\s*(.*?)\s*-\s*nick hosewol', fn.lower())
                if m_part:
            ...
            cat_id = 4
            if "ellenanthonissen" in fn.lower():
                author = "Ellen Anthonissen"
            ...
            if "denk examenvragen" in fn.lower():
            ...
            elif "jelger jansen" in fn.lower():
                author = "Jelger Jansen"
                title = "Examenvragen (Oplossing)"
                tags.extend(["Reconstructie / Vragen", "Oplossing", "Handgeschreven"])
                ...
                author = "Danaë Van de Velde" if "danaë" in path.lower() else None
            ...
            if ext == "html":
                ...
                if m_dt:
                    ...
                    tags.append("Lesnotities")
            elif "ellen anthonissen" in fn.lower():
                author = "Ellen Anthonissen"
            ...
            cat_id = 3
            if "hgc_theorie" in fn.lower() and "sarah muys" in fn.lower():
                year = "2017 - 2018"
                author = "Sarah Muys"
                title = "Samenvatting Theorie"
                tags.extend(["Theorie", "Handgeschreven"])
            elif "hgc_samenvatting" in fn.lower() and "sarah muys" in fn.lower():
                year = "2017 - 2018"
                author = "Sarah Muys"
                title = "Samenvatting"
                tags.append("Handgeschreven")
            elif "tibo geenen" in fn.lower():
                year = "2018 - 2019"
                author = "Tibo Geenen"
                ...
                tags.append("Handgeschreven")
            elif "antoine van luchem" in fn.lower() or "antoine_van_luchem" in fn.lower():
                author = "Antoine Van Luchem"
                title = "Samenvatting Halfgeleidercomponenten"
    ...
    # 8. H01L6A: Digital Signal Processing
        ...
        if "bodeplotmaker.mw" in fn.lower():
            ...
            cat_id = 2
            if "maarten de baecke" in fn.lower():
                year = "2023 - 2024"
                author = "Maarten De Baecke"
                ...
                tags.append("Opgave (Blanco)")
            elif "nicolas minne" in fn.lower():
                year = "2023 - 2024"
                author = "Nicolas Minne"
                ...
                tags.append("Januari")
            elif "karolien poppeliers" in fn.lower():
                year = "2023 - 2024"
                author = "Karolien Poppeliers"
                title = "Inhaalexamen April 2024 - Reconstructie"
                tags.append("Reconstructie / Vragen")
            elif "tibo mattheus" in fn.lower():
                year = "2023 - 2024"
                author = "Tibo Mattheus"
            ...
            cat_id = 2
            if "danaë van de velde" in fn.lower():
                author = "Danaë Van de Velde"
                ...
                tags.append("Januari")
            elif "matthias demaerschalk" in fn.lower():
                year = "2018 - 2019"
                author = "Matthias Demaerschalk"
                title = "Examenvragen"
                tags.append("Reconstructie / Vragen")
            elif "abraham belderbos" in fn.lower():
                year = "2018 - 2019"
                author = "Abraham Belderbos"
                title = "Examenvragen (Oplossing)"
                tags.extend(["Reconstructie / Vragen", "Oplossing", "Theorie"])
                ...
                title = "Examenvragen Uitgeschreven"
                tags.extend(["Reconstructie / Vragen", "Handgeschreven"])
            elif "lara roosens" in fn.lower():
                year = "2020 - 2021"
                author = "Lara Roosens"
                title = "Examenvragen"
                tags.extend(["Reconstructie / Vragen", "Handgeschreven"])
            elif "linde nouwen" in fn.lower() or "linde_nouwen" in fn.lower():
                author = "Linde Nouwen"
                title = "Examenvragen"
                tags.append("Reconstructie / Vragen")
    ...
    # 9. H01L4A: Digitale en analoge communicatie
        ...
        if "dac_faq.docx" == fn.lower():
            ...
            cat_id = 2
            if "jasper visterin" in full_context_lower:
                year = "2022 - 2023"
                author = "Jasper Visterin"
