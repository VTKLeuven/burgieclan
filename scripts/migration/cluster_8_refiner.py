...
def extract_author_from_record(doc):
    ...
    # 1. Check filename parenthesized author e.g. (Lukas Hiel) or (Jarne Van Geyseghem 2023-2024)
    ...
    # 2. Check path parenthesized author e.g. /Lecture Notes (Willem De Brandt)/
