...
def extract_author_from_record(doc):
    ...
    known_authors = [
        ('Thibaud Van Elsué', ['thibaud_van_elsué', 'thibaud van elsué', 'thibaud van elsue']),
        ('Sarah Muys', ['sarah muys', 'sarah_muys']),
        ('Nick Hosewol', ['nick hosewol', 'nick_hosewol']),
        ('Anthony Smet', ['anthony smet', 'anthony_smet']),
        ('Lukas Vanden Broeck', ['lukasvandenbroeck', 'lukas vanden broeck', 'lukas vandenbroeck']),
        ('Bram Verbelen', ['bram verbelen']),
        ('Amélie Petitjean', ['améliepetitjean', 'amélie petitjean', 'amelie petitjean']),
        ('Oscar Neyrinck', ['oscar neyrinck']),
        ('Oscar', [' - oscar.pdf', 'oscar.pdf']),
        ('Elisabeth Deryckere', ['elisabeth deryckere', 'elisabeth_deryckere']),
        ('Nina Jaeken', ['nina jaeken', 'nina_jaeken']),
        ('Alexander Van Hunsel', ['alexander van hunsel', 'alexander_van_hunsel']),
        ('Jasper Visterin', ['jasper visterin', 'jasper_visterin']),
        ('Karolien Poppeliers', ['karolienpoppeliers', 'karolien poppeliers']),
        ('Sverre Van Mullem', ['sverre van mullem', 'sverre_van_mullem']),
        ...
        ('Maria Verdonck', ['maria verdonck']),
        ('Nele Demeersseman', ['nele demeersseman', 'nele_demeersseman']),
        ('Tessy Geldof', ['tessy geldof', 'tessy_geldof']),
        ('Tibo Fordeyn', ['tibo fordeyn', 'tibo_fordeyn']),
    ]
...
def has_handwriting(doc):
    ...
    if any(k in path_fn for k in ["handgeschreven", "handwritten", "manueel", "eigen notities", "eigen nota", "notities 2016-2017 (sarah muys)"]):
        return True
