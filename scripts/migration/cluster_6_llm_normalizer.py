...
NON_AUTHOR_TOKENS = {
    ...
    'het moderne', 'lise chris', 'paper architectuurtheorie', 'paper student 008',
...
def parse_at_paper_filename(fn_no_ext):
    ...
    # Pattern like "Tuur_Lenaerts", "Student 008", "Menno Mestrom", "Anneleen Van der Veken"
...
def extract_student_author(doc):
    ...
    # 2. Specific author in folder path e.g. /notities Bram Vandroogenbroeck/ or /Student 114/
    ...
    # 6. Underscore name: "Student_017", "Lily_Vreven", "Nathalie_Voeten", "Student012"
