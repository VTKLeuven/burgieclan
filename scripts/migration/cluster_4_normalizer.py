...
KNOWN_STUDENT_AUTHORS = {
    'lukas hiel': 'Lukas Hiel',
    'nick hosewol': 'Nick Hosewol',
    'kato kenis': 'Kato Kenis',
    'jorn hendrickx': 'Jorn Hendrickx',
    'rob nickmans': 'Rob Nickmans',
    'josse naert': 'Josse Naert',
    'ryan de koninck': 'Ryan De Koninck',
    'maxim bijnens': 'Maxim Bijnens',
    'veronique lenaerts': 'Veronique Lenaerts',
    'kwinten van meerbeek': 'Kwinten Van Meerbeek',
    'diete wouters': 'Diete Wouters',
    'hannelore mussen': 'Hannelore Mussen',
    'silke van poeyer': 'Silke Van Poeyer',
    'bram de maesschalck': 'Bram De Maesschalck',
    'danaë van de velde': 'Danaë Van de Velde',
    'danae van de velde': 'Danaë Van de Velde',
    'eveline wuytens': 'Eveline Wuytens',
    'wout de herdt': 'Wout De Herdt',
    'martijn deckers': 'Martijn Deckers',
    'aurian baudhuin': 'Aurian Baudhuin',
    'koen geerts': 'Koen Geerts',
    'hanna leysen': 'Hanna Leysen',
    'laurens de poorter': 'Laurens De Poorter',
    'caro de brouwer': 'Caro De Brouwer',
    'ruben cartuyvels': 'Ruben Cartuyvels',
    'yannou ravout': 'Yannou Ravout',
    'frédéric blondeel': 'Frédéric Blondeel',
    'frederic blondeel': 'Frédéric Blondeel',
    'linde nouwen': 'Linde Nouwen',
    'lindenouwen': 'Linde Nouwen',
    'ellen anthonissen': 'Ellen Anthonissen',
    'annelien eyskens': 'Annelien Eyskens',
    'joris guldentops': 'Joris Guldentops',
    'sarah muys': 'Sarah Muys',
    'daniël slenders': 'Daniël Slenders',
    'daniel slenders': 'Daniël Slenders',
    'dani¨el slenders': 'Daniël Slenders',
    'xan decoutere': 'Xan Decoutere',
    'tibo geenen': 'Tibo Geenen',
    'jasper vis': 'Jasper Vis',
    'jaspervis': 'Jasper Vis',
    'enya lindekens': 'Enya Lindekens',
    'raphael six': 'Raphael Six',
    'raphaël six': 'Raphael Six',
    'matthias demaerschalk': 'Matthias Demaerschalk',
    'maarten h.': 'Maarten H.',
    'k. segers': 'K. Segers',
    'k segers': 'K. Segers',
    'gladines': 'Gladines',
