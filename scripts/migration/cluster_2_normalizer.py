...
PROFESSORS = [
    ...
    "huyse", "belis", "jeroen belis", "creemers", "van der perre", "van bael",
...
def extract_author(record):
    ...
    known_authors = [
        ("Glenn Peeters", ["glenn peeters", "glenn_peeters"]),
        ("Kato Kenis", ["kato kenis", "kato_kenis"]),
        ("Nick Hosewol", ["nick hosewol", "nick_hosewol", "nick hosewoll", "nick_hosewoll"]),
        ("Lukas Vanden Broeck", ["lukas vanden broeck", "lukasvandenbroeck", "lukas vandenbroeck", "lukas_vanden_broeck"]),
        ("Thibaud Van Elsué", ["thibaud van elsué", "thibaud van elsue", "thibaud van_elsué", "thibaud_van_elsué", "thibaud van elsue"]),
        ("Jarne Van Geyseghem", ["jarne van geyseghem", "jarne_van_geyseghem"]),
        ("Sara Speelman", ["sara speelman", "sara_speelman"]),
        ("Jasper Vis", ["jasper vis", "jasper_vis"]),
        ("Jasper Visterin", ["jasper visterin", "jasper_visterin"]),
        ("Martijn Deckers", ["martijn deckers", "martijn_deckers"]),
        ("Lisa Corten", ["lisa corten", "lisa_corten"]),
        ("Simon Beelen", ["simon beelen", "simon_beelen"]),
        ("Jilmen Quintens", ["jilmen quintens", "jilmen quintiens"]),
        ("Maxim Bijnens", ["maxim bijnens", "maxim_bijnens"]),
        ("Wouter Janssens", ["wouter janssens"]),
        ("Thomas Swerts", ["thomas swerts"]),
        ("Maksim Nesterenko", ["maksim nesterenko"]),
        ("Quinten Goris", ["quinten goris"]),
        ("Sarah Muys", ["sarah muys"]),
        ("Ian Mertens", ["ian mertens"]),
        ("Tiziana Dozin", ["tiziana dozin"]),
        ("Veronique Lenaerts", ["veronique lenaerts"]),
        ("Naomi Adam", ["naomi adam"]),
        ("Hannelore Mussen", ["hannelore mussen"]),
        ("Noah Steinier", ["noah steinier"]),
        ("Jorn Witters", ["jorn witters"]),
        ("Diete Wouters", ["diete wouters"]),
        ("Bram Rosseels", ["bram rosseels"]),
        ("Laura Lenaerts", ["laura lenaerts"]),
        ("Arthur Stockman", ["arthur stockman"]),
        ("Tibo Geenen", ["tibo geenen"]),
        ("Xan Decoutere", ["xan decoutere", "xandecoutere"]),
        ("Katrijn De Rooster", ["katrijn de rooster", "katrijn_de_rooster"]),
        ("Olivier Renders", ["olivier renders"]),
        ("Kobe Avonds", ["kobe avonds"]),
        ("Daniel Van Gerven", ["daniel van gerven"]),
        ("Jeroen Claesen", ["jeroen claesen"]),
        ("Robin Ska", ["robin ska"]),
        ("Willem Vanmoerkerke", ["willem vanmoerkerke"]),
        ("Mieke Rens", ["mieke rens"]),
        ("Annelien Eyskens", ["annelien eyskens"]),
        ("Aurian Baudhuin", ["aurian baudhuin"]),
        ("Matthias Demaerschalck", ["matthias demaerschalck"]),
        ("Peter Vlaminck", ["peter vlaminck"]),
        ("Wout Smellenbergh", ["wout smellenbergh"]),
        ("Raphael Six", ["raphael six"]),
        ("Emma Haeverans", ["emma haeverans"]),
        ("Stefanie Gantois", ["stefanie gantois"]),
        ("Robbert Hofman", ["robbert hofman"]),
        ("Arthur Thevelin", ["arthur thevelin"]),
        ("Maarten Brusselmans", ["maarten brusselmans"]),
        ("Ruben Cartuyvels", ["ruben cartuyvels"]),
        ("Roald Segers", ["roald segers", "segers roald"]),
        ("Matthias Sempels", ["matthias sempels"]),
        ("Marie Gladines", ["marie gladines"]),
        ("Wouter Beert", ["wouter beert"]),
        ("Mattias Decrop", ["mattias decrop"]),
        ("Victor Nijssen", ["victor nijssen"]),
        ("Zias Akkermans", ["zias akkermans"]),
        ("Elise Van Vlierberghe", ["elise van vlierberghe", "elise-van-vlierberghe"]),
        ("Bram Verbelen", ["bram verbelen"]),
        ("Ben Jacobs", ["ben jacobs", "benjacobs"]),
        ("Daniël Slenders", ["daniël slenders", "daniel slenders"]),
        ("Thomas De Wolf", ["thomas de wolf", "thomas_de_wolf", "thomas de wolf"]),
        ("Elisabeth Deryckere", ["elisabeth deryckere", "elisabeth_deryckere"]),
        ("Tijl Vanneste", ["tijlvanneste", "tijl vanneste"]),
        ("Tiemen Aerts", ["tiemen aerts", "tiemen_aerts"]),
        ("Caro De Brouwer", ["caro de brouwer"]),
        ...
        ("Dries", ["nota's dries"]),
        ("Laurens De Poorter", ["laurens de poorter", "laurens_de_poorter"]),
        ("Laurens", ["(laurens)"]),
        ("Snoekie", ["(snoekie)"])
    ]
