 ...
 */
final class Version20240229110309 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE course_comment (id INT AUTO_INCREMENT NOT NULL, course_id INT NOT NULL, category_id INT NOT NULL, content LONGTEXT NOT NULL, INDEX IDX_9CB75780591CC992 (course_id), INDEX IDX_9CB7578012469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
