...
def main():
    ...
    for i, d in enumerate(docs):
        ...
        elif fn == "Gids voor eerstejaars - 2020-2021 (Jasper Vis).pdf":
            display_title = "Gids voor Eerstejaars (Jasper Vis)"
            category_id = 3
            year = "2020 - 2021"
            author = "Jasper Vis"
            tags = ["Studiewijzer / Gids"]
        ...
        elif fn == "Anki Flashcards Semester 1 (Jarne Van Geyseghem 2021-2022).apkg":
            display_title = "Anki Flashcards Semester 1 (Jarne Van Geyseghem)"
            category_id = 3
            year = "2021 - 2022"
        ...
        # 2. Samenvattingen
        elif fn == "Handleiding oefeningen 2016-2017 (Tibo Geenen).pdf":
            display_title = "Handleiding Oefeningen (Tibo Geenen)"
            category_id = 3
            year = "2016 - 2017"
            author = "Tibo Geenen"
            tags = ["Handgeschreven", "Scan"]
            
        elif fn == "Nuttige Taylorveeltermen (Riet Van Puyenbroeck).pdf":
            display_title = "Formularium Nuttige Taylorveeltermen (Riet Van Puyenbroeck)"
            category_id = 3
            author = "Riet Van Puyenbroeck"
            tags = ["Formularium"]
            
        elif fn == "Samenvatting & Formules 2016-2017 (Arthur Stockman).pdf":
            display_title = "Samenvatting & Formules (Arthur Stockman)"
            category_id = 3
            year = "2016 - 2017"
            author = "Arthur Stockman"
            tags = ["Formularium", "Handgeschreven", "Scan"]
            
        elif fn == "Samenvatting 2009-2010 (Laurens De Poorter).pdf":
            display_title = "Samenvatting Analyse 1 (Laurens De Poorter)"
            category_id = 3
            year = "2009 - 2010"
            author = "Laurens De Poorter"
            tags = ["Handgeschreven", "Scan"]
            
        elif fn == "Samenvatting 2024-2025 (Hanna Leysen).pdf":
            display_title = "Samenvatting Analyse 1 (Hanna Leysen)"
            category_id = 3
            year = "2024 - 2025"
            author = "Hanna Leysen"
            tags = ["Handgeschreven", "Scan"]
            
        elif fn == "samenvatting_analyse1 (LukasVandenBroeck).pdf":
            display_title = "Samenvatting Analyse 1 (Lukas Vanden Broeck)"
            category_id = 3
            author = "Lukas Vanden Broeck"
            tags = ["Handgeschreven", "Scan"]
        ...
        elif fn == "Schema's 2024-2025 (Hanna Leysen).pdf":
            display_title = "Schema's Analyse 1 (Hanna Leysen)"
            category_id = 3
            year = "2024 - 2025"
            author = "Hanna Leysen"
            tags = ["Formularium", "Handgeschreven", "Scan"]
            
        elif "Samenvatting 2016-2017 (Sarah Muys)" in path:
            display_title = "Samenvatting Analyse 1 (Sarah Muys)"
            category_id = 3
            year = "2016 - 2017"
            author = "Sarah Muys"
        ...
        elif fn == "oefeningen_analyse1 (LukasVandenBroeck).pdf":
            display_title = "Oefeningen Analyse 1 (Lukas Vanden Broeck)"
            category_id = 4
            author = "Lukas Vanden Broeck"
            tags = ["Handgeschreven", "Scan", "Oplossing"]
        elif fn == "Extra oef analyse 1 Wouter Moors.zip":
            display_title = "Extra Oefeningen Analyse 1 (Wouter Moors)"
            category_id = 4
            author = "Wouter Moors"
            tags = []
        elif fn == "Oefenzittingen 2009-2010 (Laurens de Poorter).pdf":
            display_title = "Oefenzittingen Analyse 1 (Laurens De Poorter)"
            category_id = 4
            year = "2009 - 2010"
            author = "Laurens De Poorter"
            tags = ["Handgeschreven", "Scan", "Oplossing"]
